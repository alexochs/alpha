...
export default function HabitTracker({ profileId, date }: any) {
                    ...
                    <HStack spacing="1rem">
                        ...
                        <Box>
                            ...
                            <Checkbox
                                ...
                                isChecked={newHabitDays.includes("wednesday")}
                                colorScheme="yellow"
                                size="lg"
                                isInvalid={invalidHabitDays}
                            />
                        ...
                        <Box>
                            ...
                            <Checkbox
                                ...
                                isChecked={newHabitDays.includes("thursday")}
                                colorScheme="yellow"
                                size="lg"
                                isInvalid={invalidHabitDays}
                            />
                        ...
                        <Box>
                            ...
                            <Checkbox
                                ...
                                isChecked={newHabitDays.includes("saturday")}
                                colorScheme="yellow"
                                size="lg"
                                isInvalid={invalidHabitDays}
                            />
