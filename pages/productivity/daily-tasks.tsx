...
export default function DailyTasksPage({ profileId, date }: any) {
    ...
    return isMobile ? (
        <Center ml="5vw" w="90vw" flexDir="column">
            <VStack spacing="1rem">
                <Text fontSize="3xl" fontWeight={"bold"} letterSpacing="0.1rem">
                    Create a task
                </Text>
                ...
                <HStack spacing="1rem" w="90vw">
                    <Flex flexDir="column" w="100%">
                        ...
                        <Select
                            value={newTaskDifficulty}
                            onChange={(e) =>
                                setNewTaskDifficulty(parseInt(e.target.value))
                            }
                            rounded="full"
                        >
                            <option value={1}>1</option>
                    ...
                    <Flex flexDir="column" w="100%">
                        ...
                        <Select
                            value={newTaskImportance}
                            onChange={(e) =>
                                setNewTaskImportance(parseInt(e.target.value))
                            }
                            rounded="full"
                        >
                            <option value={1}>1</option>
                            ...
                            {tasks
                                ...
                                .map((task, index) => (
                                    <Tr key={index}>
                                        <Td>{task.name}</Td>
                                        <Td isNumeric fontWeight={"bold"}>
                                            {task.difficulty + task.importance}
                                        </Td>
                                        <Td>
                                            <Checkbox
                                                onChange={() =>
